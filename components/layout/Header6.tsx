...
const Header6 = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }: HeaderProps) => {
    ...
    return (
        ...
        <header className={`main-header header-style-four style-dark style-home5 ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
            <div className="header-lower">
                <div className="main-box style-two">
