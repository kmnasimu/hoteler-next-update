...
function Header5 ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }: HeaderProps){
    ...
    return (
        ...
        <header className={`main-header header-style-four style-dark ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
            <div className="header-top">
                <div className="auto-container">
                    <div className="inner-box">
                    <div className="top-left">
                        <span><i className="icon fa-solid fa-envelope" /> needhelp@company.com</span>
                        <span><i className="icon fa-sharp fa-solid fa-phone" /> 000 111 222 333</span>
                    </div>
                    <div className="top-right">
                        ...
                        <div className="info-language"><div className="select-language">English <i className="icon fa-sharp fa-solid fa-caret-down" /></div></div>
                        <div className="info-user"><i className="icon fa-light fa-user" /></div>
                    </div>
                    </div>
                </div>
            </div>
            <div className="auto-container">
                <div className="main-box px-sm-0">
                    <div className="logo-box">
                        <div className="logo"><Link href="/"><Image src={LogoWhite} alt="Logo" style={{ width: "auto", height: "auto" }} /></Link></div>
                    </div>
