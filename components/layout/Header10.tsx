...
const Header10 = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }: HeaderProps) => {

    return (
        <>

        <header className={`main-header header-style-three style-home6 ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
